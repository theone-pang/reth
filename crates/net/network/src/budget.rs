...
/// Default budget to try and drain stream of
/// [`NetworkConsensusEvent`](crate::consensus::NetworkConsensusEvent)s from
/// [`NetworkManager`](crate::NetworkManager).
///
/// Default is 10 incoming transaction messages.
pub const DEFAULT_BUDGET_TRY_DRAIN_NETWORK_CONSENSUS_EVENTS: u32 = DEFAULT_BUDGET_TRY_DRAIN_SWARM;

/// [`NetworkClayerManager`](crate::consensus::NetworkClayerManager) future.
//
// Default is 40 pending pool imports.
pub const DEFAULT_BUDGET_TRY_DRAIN_PENDING_CONSENSUS_IMPORTS: u32 =
    4 * DEFAULT_BUDGET_TRY_DRAIN_STREAM;
