...
use reth_network_api::{
    ...
    NetworkEventListenerProvider, NetworkInfo, NetworkSecretKey, NetworkStatus, PeerInfo,
...
impl NetworkHandle {
    ...
    /// Send full consensus to the peer
...
impl NetworkSecretKey for NetworkHandle {
    fn network_secret_key(&self) -> &SecretKey {
        &self.inner.secret_key
    }
}
