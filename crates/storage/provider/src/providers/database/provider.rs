use crate::{
    ...
    BlockReader, BlockWriter, BundleStateInit, ConsensusNumberReader, ConsensusNumberWriter,
    DBProvider, EvmEnvProvider, FinalizedBlockReader, FinalizedBlockWriter, HashingWriter,
...
use reth_db::{
    cursor::DbDupCursorRW, models::ConsensusBytes, tables, BlockNumberList, PlainAccountState,
    PlainStorageState,
};
use reth_db_api::{
    common::KeyValue,
...
impl<TX: DbTx, Spec: Send + Sync + EthereumHardforks> ConsensusNumberReader
    for DatabaseProvider<TX, Spec>
{
...
impl<TX: DbTxMut + DbTx + 'static, Spec: Send + Sync + EthereumHardforks + 'static>
    ConsensusNumberWriter for DatabaseProvider<TX, Spec>
{
    /// Save stage checkpoint.
